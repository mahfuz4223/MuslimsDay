...
public class TafsirAdapter extends RecyclerView.Adapter<TafsirAdapter.TafsirViewHolder> {
  ...
  @Override
  public TafsirViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view =
        LayoutInflater.from(parent.getContext()).inflate(R.layout.row_tafsir, parent, false);
    TafsirViewHolder viewHolder = new TafsirViewHolder(view);
    return viewHolder;
  }

  @Override
  public void onBindViewHolder(TafsirViewHolder holder, int position) {
